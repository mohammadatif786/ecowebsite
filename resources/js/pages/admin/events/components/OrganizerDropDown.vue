<template>
    <div class="form-section">
        <h2>Select organizer for an event</h2>
        <!-- Toggle buttons -->
        ...
        <div class="form-fields" v-if="showFields[0]">
            <div class="form-group">
                ...
                <select id="event-organizer" v-model="modelValue">
                    <option value="">Select Organizer</option>
                    <option v-for="organizer in organizer_details" :key="organizer.id" :value="organizer.id">
...
const props = defineProps<{
    organizer_details: Array<{ id: number; organizer_name: string }>
    errors?: string[];
    events: Array<Record<string, null>>
}>();

// v-model now directly controls `organizer_id` (number or null)
const modelValue = defineModel<number | null>({
    default: null,
});

const showFields = ref<{ [k: number]: boolean }>({ 0: !!props.organizer_details });
