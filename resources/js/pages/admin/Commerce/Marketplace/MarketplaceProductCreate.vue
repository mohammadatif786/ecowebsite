...
import { PackagePlus, ChevronLeft } from 'lucide-vue-next';
...
<template>
    <Head title="Create Marketplace Product" />
            ...
            <section class="p-5 lg:p-8 space-y-6">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <h3 class="text-3xl font-black text-slate-950 flex items-center gap-3"><PackagePlus class="w-8 h-8" /> Add New Product</h3>
                    </div>
                </div>

                <MarketplaceProductForm :categories="categories" :sellers="sellers" />
            </section>
        </main>
    </div>
</template>
