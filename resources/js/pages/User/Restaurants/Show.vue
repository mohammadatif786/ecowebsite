        ...
        <Card>
            <CardContent>
                <Carousel class="relative w-[90%] mx-auto">
                    <CarouselContent>
                        <CarouselItem v-for="(photo, index) in restaurant.photos" :key="index">
                ...
                <div class="px-3 py-4">
                    <div class="flex justify-between items-center gap-1 mb-3">
                        <h3 class="font-bold text-2xl">{{ restaurant.name }}</h3>
                    ...
                    <div class="flex flex-col gap-2 mb-4">
                        ...
                        <div class="flex justify-between items-center text-lg font-medium">
                            ...
                            <div class="text-yellow-500">{{ restaurant.availablitiy ? 'Open now' : 'Closed' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center items-center gap-4 mb-8">
                        ...
                        <!-- <div class="bg-white flex gap-1 flex-col items-center text-center p-4 w-30 rounded">
                            ...
                            <span class="text-yellow-500 font-medium">{{ restaurant.user_ratings_total }}</span>
                        </div> -->
                        <div class="bg-white flex gap-1 flex-col items-center text-center p-4 w-30 rounded">
                            <CameraIcon />
                            <span class="font-medium">Photos</span>
                            <span class="text-yellow-500 font-medium">{{ restaurant.photos.length }}</span>
                        </div>
                    </div>
                        ...
                        <div>
                            <div>
                                <div v-if="restaurant.reviews && restaurant.reviews.length">
                                    <div
                                        v-for="(review, idx) in restaurant.reviews"
                                        :key="idx"
