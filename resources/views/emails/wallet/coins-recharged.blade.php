...
<head>
    ...
    <title>Coins Purchased Successfully - Link Up</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="margin: 16px 0 8px 0; color: #1e293b;">Coins Purchased Successfully</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="amount">{{ $formattedCoins }}</div>

            <div class="info-box">
                <strong>Purchase Details:</strong><br>
                <strong>Amount Paid:</strong> {{ $formattedAmount }}<br>
                <strong>Coins Received:</strong> {{ $formattedCoins }}<br>
                <strong>Date:</strong> {{ now()->format('F j, Y \a\t g:i A') }}
            </div>

            <p>The coins have been added to your account and are now available for use.</p>

            <p>You can view your updated balance in your wallet dashboard.</p>
