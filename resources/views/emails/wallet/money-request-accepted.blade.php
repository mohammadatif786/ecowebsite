...
<head>
    ...
    <title>Money Request Accepted - Link Up</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="margin: 16px 0 8px 0; color: #1e293b;">Money Request Accepted</h1>
        </div>

        <div class="content">
            <p>Hi {{ $payee->name }},</p>
            
            <p>Great news! Your money request has been accepted.</p>

            <div class="amount">{{ $formattedAmount }}</div>

            <div class="info-box">
                <strong>Transaction Details:</strong><br>
                <strong>Paid by:</strong> {{ $payer->name }} ({{ $payer->linkup_id }})<br>
