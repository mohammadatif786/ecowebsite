...
<head>
    ...
    <title>Wallet Recharged Successfully - Link Up</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="margin: 16px 0 8px 0; color: #1e293b;">Wallet Recharged Successfully</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <strong>Amount Added:</strong> {{ $formattedAmount }}<br>
