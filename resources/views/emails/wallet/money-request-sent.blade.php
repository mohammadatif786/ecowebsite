...
<head>
    ...
    <title>Money Request Sent - Link Up</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="margin: 16px 0 8px 0; color: #1e293b;">Money Request Sent</h1>
        </div>

        <div class="content">
            <p>Hi {{ $requester->name }},</p>
            
            <p>Your money request has been sent successfully!</p>
            ...
            <p>Your money request has been sent to {{ $recipient->name }}. They will receive a notification and can choose to accept or reject your request.</p>

            <p>You can track the status of your request in your wallet dashboard.</p>
