...
class BuyCookoutTicketEmailMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Your Cookout Ticket Confirmation - LinkUp',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.tickets.buyCookoutTicketEmail',
            with: [
